...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'VOID'
  ...
  return (
    <FCard>
      {farm.token.symbol === 'VOID' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        {farm.isTokenOnly ? <DetailsSection
          removed={removed}
          bscScanAddress={`https://bscscan.com/address/${farm.token.address[56]}`}
